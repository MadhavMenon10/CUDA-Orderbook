...
constexpr int MAX_LEVELS_PER_LANE = 128; // Number of distinct price levels a single one of the warp's 32 lanes is allowed to hold in its own small local array at once
